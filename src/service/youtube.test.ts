...
test('handleYoutubeLiveBroadcastResponse throws against the token expired error', () => {
  ...
  expect(() => handleYoutubeLiveBroadcastResponse(ok, response)).toThrow(YoutubeRequestError)
})
...
test('handleYoutubeLiveChatMessageResponse throws against an invalid data', () => {
  ...
  expect(() => handleYoutubeLiveChatMessageResponse(ok, response)).toThrow(Error)
})
...
test('handleYoutubeLiveChatMessageResponse throws against the token expired error', () => {
  ...
  expect(() => handleYoutubeLiveChatMessageResponse(ok, response)).toThrow(YoutubeRequestError)
})
