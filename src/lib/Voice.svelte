...
<script lang="ts">
  export let voiceEn: string = defaultVoiceEn
  export let voiceJa: string = defaultVoiceJa
  export let voiceUnd: string = defaultVoiceUnd
</script>
...
<main>
  <p>
    ...
    <button type="button" class="play" value="Hello">▶️</button>
  </p>
  <p>
    ...
    <button type="button" class="play" value="こんにちは">▶️</button>
  </p>
  <p>
    ...
    <button type="button" class="play" value="42">▶️</button>
  </p>
</main>