...
export const DEFAULT_CONTEXT: AppContext = {
  ...
  youtubeClientId: '244926935062-j7pehh8c98tg19crb1ipbugd3ikdrpcn.apps.googleusercontent.com',
  youtubeRefreshEndpoint: 'https://chattalker-34in68ly.uc.gateway.dev/youtube-oauth2refresh'
}
